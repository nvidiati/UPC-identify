...
$resultado = file_get_contents("https://www.target.com/p//-/A-".$bc1);

$string = $resultado;


if (preg_match_all("'<div height=\"1\" width=\"1\" class=\"AspectRatio__AspectRatioContainer-sc-1h9ishl-0 ljIhnG\">(.*?)</div>'si", $string, $matches))
{


    foreach($matches[1] as $val)
    {
        echo "<div style='width:100px'>".$val."</div>";
      //  echo "------------------------------<br />";
    }
...
$resultado = file_get_contents("https://www.target.com/p//-/A-".$bc1."%2c".$bc2."%2c".$bc3."%2c".$bc4."%2c".$bc5."%2c".$bc6."%2c".$bc7."%2c".$bc8."%2c".$bc9."%2c".$bc10);
